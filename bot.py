...
async def start(client, message):
 await message.reply_text(text =f""" https://telegra.ph/file/7fa9017265d3d6f51d191.jpg ʜᴇʟʟᴏ  ᴅᴇᴀʀ  {message.from_user.first_name } ᴡʟᴄᴍ ᴛᴏ ɪᴍᴀɢᴇ ᴛᴏ  ᴘᴅғ ᴄᴏɴᴠᴇʀᴛᴏʀ ʙᴏᴛ ᴍᴀᴅᴇ ʙʏ @itz_mst_boy 
...
ᴛʜɪs  ʙᴏᴛ  ɪs  ᴄʀᴇᴀᴛᴇᴅ  ʙʏ  @iTz_mSt_bOy """,reply_to_message_id = message.message_id ,  reply_markup=InlineKeyboardMarkup(
            [
                [
                 ...
                 [InlineKeyboardButton("ᴍᴏɪ ᴏᴡɴᴇʀ ✨", url="https://t.me/itz_mst_boy") ]       ]        ) )
